      ...
      <div className="container mx-auto px-6 py-10 flex-grow">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-sm border border-gray-100">
          ...
          <div className="prose prose-sm max-w-none text-gray-700">
            <p className="mb-6">
              Welcome to BidScents, your trusted preowned perfume marketplace!
              Whether you're a beginner or a seasoned collector, follow this
              step-by-step guide to make your purchase safe, smooth, and
              enjoyable.
            </p>
            ...
            <p>
              Explore our wide range of designer, niche, local house, and
              Arabian perfumes. When you find a scent you like, click on the
              listing to view details such as:
            </p>
            ...
            <p>We take counterfeit prevention seriously. Before proceeding:</p>
            <ul className="list-disc pl-5 mb-4 space-y-2 mt-2">
              ...
              <li>
                If something looks suspicious, report the listing to admin using
                the "Report" button. We'll take action immediately.
              </li>
            </ul>
            ...
            <p>If the perfume looks legit and you're happy with the price:</p>
            <ul className="list-disc pl-5 mb-4 space-y-2 mt-2">
              <li>Use our secure chat system to message the seller</li>
              <li>
                Ask for extra pictures, receipt/proof of purchase, or a video if
                needed
              </li>
            ...
            <p>Once you're satisfied:</p>
            <ul className="list-disc pl-5 mb-4 space-y-2 mt-2">
              <li>Agree on payment method in the chat</li>
              <li>
                Send your proof of payment and shipping details (full name,
                address, phone number)
              </li>
              <li>The seller will then process and ship your item</li>
            </ul>
            <p className="text-amber-600 font-medium">
              ⚠️ Never share sensitive information like bank login or OTPs. Stay
              within the chat for security.
            </p>

            <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-800">
              ⭐ Step 5: Confirm & Rate the Seller
            </h2>
            <p>After receiving your perfume:</p>
            <ul className="list-disc pl-5 mb-4 space-y-2 mt-2">
            ...
            <div className="bg-purple-50 p-4 rounded-lg mt-8 mb-12">
              ...
              <p className="text-purple-700">
                We're working hard to introduce Buyer Protection and an Escrow
                Service to ensure you can shop with total peace of mind.
              </p>
            </div>
            ...
            <p className="mb-6">
              The Seller Dashboard is your personal hub to manage everything
              related to your listings on BidScents. Whether you're selling one
              bottle or building a side hustle, we make it simple and efficient.
            </p>

            <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-800">
              📦 View All Your Listings in One Place
            </h3>
            <p>Access your entire perfume inventory from the dashboard:</p>
            <ul className="list-disc pl-5 mb-4 space-y-2 mt-2">
            ...
            <p>Need to make changes? You're in control.</p>
            <ul className="list-disc pl-5 mb-4 space-y-2 mt-2">
              <li>
                Edit your listings to update price, photos, or description
              </li>
              <li>
                Delete items that are no longer available or sold outside the
                platform
              </li>
            ...
            <p>Want to reach more buyers? Try our Featured Listing service!</p>
            <ul className="list-disc pl-5 mb-4 space-y-2 mt-2">
            ...
            <p>
              Coming soon: analytics tools to show how your listings are
              performing!
            </p>
