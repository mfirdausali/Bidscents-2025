...
- [V4](https://billplz-sandbox.com/api#v4)  - [Collections](https://billplz-sandbox.com/api#v4-collections)    - [Create a Collection](https://billplz-sandbox.com/api#v4-collections-create-a-collection)
  ...
  - [Tokenization](https://billplz-sandbox.com/api#v4-tokenization)    - [Senangpay](https://billplz-sandbox.com/api#v4-tokenization-senangpay)      - [Create Card](https://billplz-sandbox.com/api#v4-tokenization-senangpay-create-card)
      ...
      - [Pre-Auth](https://billplz-sandbox.com/api#v4-tokenization-senangpay-pre-auth)
...
| --- | --- |
| payment\_order\_collection\_id | The Payment Order Collection ID. A string. |
| bank\_code | [SWIFT Bank Code](https://billplz-sandbox.com/api#v5-payment-order-swift-bank-code-table) that represents bank, in string value. Case sensitive. |
...
| epoch | The current time in UNIX epoch time format. |
| checksum | Required values for [checksum signature](https://billplz-sandbox.com/api#v5-checksum) in this order: **\[ payment\_order\_collection\_id, bank\_account\_number, total, epoch \]** |
...
| reference\_id | Payment Order's unique reference ID scoped by [Payment Order Collection](https://billplz-sandbox.com/api#v5-payment-order-collections). This helps maintain data integrity by ensuring that no two rows of data in a payment order collection have identical reference\_id value. Useful to prevent unintentional payment order creation. (Max of 255 characters). |
...
| epoch | The current time in UNIX epoch time format. |
| checksum | Required values for [checksum signature](https://billplz-sandbox.com/api#v5-checksum) in this order: **\[ payment\_order\_id, epoch \]** |
...
| --- | --- |
| epoch | The current time in UNIX epoch time format. |
| checksum | Required values for [checksum signature](https://billplz-sandbox.com/api#v5-checksum) in this order: **\[ epoch \]** |
...
| bank\_code | string | The Duitnow::Pay registered bank code, please refer to [API#v5-payment-gateways](https://billplz-sandbox.com/api#v5-payment-gateways) on how to obtain the correct bank code |
...
| checksum | string | Required values for [checksum signature](https://billplz-sandbox.com/api#v5-checksum) in this order: **\[ merchant\_ref, max\_amount, effective\_date, expiry\_date, frequency, callback\_url, epoch \]** |
...
| epoch | integer | The current time in UNIX epoch time format. |
| checksum | string | Required values for [checksum signature](https://billplz-sandbox.com/api#v5-checksum) in this order: **\[ id, epoch \]** |
...
| bill\_id | String | A pending Billplz Bill ID you wish to collect from using AutoDebit. Please refer to [create-a-bill](https://billplz-sandbox.com/api#v3-bills-create-a-bill) on how to create one. |
| epoch | Integer | The current time in UNIX epoch time format. |
| checksum | String | Required values for [checksum signature](https://billplz-sandbox.com/api#v5-checksum) in this order: **\[ consent\_id, bill\_id, epoch \]** |
...
Use this API to get a complete list of supported payment gateways' bank code that need for setting `bank_code` in [API#Duitnow::Pay Consents](https://billplz-sandbox.com/api#v5-duitnow-pay-consents-create-a-consent).
...
You can find a list of all the payment gateway codes [here](https://billplz-sandbox.com/api#payment-gateway-abbreviations)
...
| --- | --- | --- |
| epoch | integer | The current time in UNIX epoch time format. |
| checksum | string | Required values for [checksum signature](https://billplz-sandbox.com/api#v5-checksum) in this order: **\[ epoch \]** |
...
![Activate the extra payment completion information.](https://billplz-sandbox.com/api/images/x_spc_transaction_setting.png)
